/* https://github.com/eddflrs/meteor-ddp/blob/master/meteor-ddp.js */
...
MeteorDdp.prototype.connect = function() {
  ...
  self.sock = ddp.wsUri.indexOf('http') && new WebSocket(self.wsUri) || new SockJS(self.wsUri);
...
MeteorDdp.prototype.unsubscribe = function(pubName) {
  ...
  return this.defs[this.id].promise();
};
